...
class SetMenuPageView extends StatelessWidget {
  ...
  const SetMenuPageView(
      {Key? key, required this.setMenuProvider, required this.pageController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        (index + 1 == totalPage)
            ? initialLength = setMenuProvider.setMenuList!.length - (index * 4)
            : 4;
        return ListView.builder(
            ...
            itemBuilder: (context, item) {
              ...
              setMenuProvider.setMenuList![currentIndex0].name!.length > 20
                  ? name =
                      '${setMenuProvider.setMenuList![currentIndex0].name!.substring(0, 20)} ...'
              ...
              double discount =
                  setMenuProvider.setMenuList![currentIndex0].price! -
                      PriceConverter.convertWithDiscount(
                          ...
                          setMenuProvider
                              .setMenuList![currentIndex0].discountType)!;

              bool isAvailable = DateConverter.isAvailable(
                  setMenuProvider
                      .setMenuList![currentIndex0].availableTimeStarts!,
                  setMenuProvider
                      .setMenuList![currentIndex0].availableTimeEnds!,
                  context);
                      ...
                      showDialog(
                          ...
                          builder: (con) => Dialog(
                                ...
                                child: CartBottomSheet(
                                  product: setMenuProvider
                                      .setMenuList![currentIndex0],
                                  fromSetMenu: true,
