  ...
  Widget build(BuildContext context) {
    return Consumer<TimerProvider>(builder: (context, orderTimer, child) {
      ...
      if (orderTimer.duration != null) {
        ...
        minutes =
            orderTimer.duration!.inMinutes - (24 * days * 60) - (hours * 60);
        seconds = orderTimer.duration!.inSeconds -
            (24 * days * 60 * 60) -
            (hours * 60 * 60) -
            (minutes * 60);
      }
        ...
        children: [
          ...
          Text(
            minutes! < 5
                ...
                : getTranslated('your_food_delivery', context)!,
...
class TimerBox extends StatelessWidget {
  ...
  const TimerBox({Key? key, this.time, this.isBorder = false, this.text})
      : super(key: key);
