  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      ...
      _scheduleOrderSlotDuration =
          int.tryParse(json['schedule_order_slot_duration'] ?? 30 as String);
    }
    ...
    if (json['loyalty_point_item_purchase_point'] != null) {
      _loyaltyPointItemPurchasePoint =
          double.parse('${json['loyalty_point_item_purchase_point']}');
    }
